...
`git add -A && git commit -m "step 1: scaffold"`.
```
...
`git add -A && git commit -m "step 3: models and repositories"`.
```
...
resolve. Then `git add -A && git commit -m "step 5: scoping"`.
```
...
`git add -A && git commit -m "step 6: adapters"`.
```
